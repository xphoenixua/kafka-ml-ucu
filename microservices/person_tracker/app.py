...
# ── Configuration ───────────────────────────────────────────────────
SERVICE_NAME = os.getenv("SERVICE_NAME", "Person Tracker")
BROKER       = os.getenv("KAFKA_BROKER", "localhost:9092")
IN_TOPIC     = os.getenv("INPUT_TOPIC", "detections-people")
OUT_TOPIC    = os.getenv("OUTPUT_TOPIC", "tracks-people")
FRAME_RATE   = int(os.getenv("FRAME_RATE", "30"))
CSV_PATH     = os.getenv("CSV_PATH", "/app/debug_output/people_tracks.csv")
